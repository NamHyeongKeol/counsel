...
export function CharacterProfile({ characterId, userId, isOpen, onClose }: CharacterProfileProps) {
    ...
    return (
        <div className="fixed inset-0 z-50">
            ...
            <div
                ref={sheetRef}
                className={`absolute bottom-0 left-0 right-0 max-h-[90vh] bg-gray-900 rounded-t-3xl overflow-hidden flex flex-col transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${isVisible ? "translate-y-0" : "translate-y-full"
                    }`}
