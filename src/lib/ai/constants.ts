...
export const AI_MODELS = {
    "gemini-3-flash-preview": { name: "3 Flash", provider: "google" as AIProvider, pricePerMToken: { input: 0.5, output: 3 } },
    "gemini-3-pro-preview": { name: "3 Pro", provider: "google" as AIProvider, pricePerMToken: { input: 2, output: 12 } },
    "claude-opus-4-5-20251101": { name: "Opus 4.5", provider: "anthropic" as AIProvider, pricePerMToken: { input: 5, output: 25 } },
