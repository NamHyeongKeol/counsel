                    ...
                    {user ? (
                        <div className="bg-white/5 rounded-2xl p-6 border border-white/10">
                            ...
                            <button
                                ...
                                className="w-full mt-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 rounded-xl text-white font-medium"
                            >
                                프로필 수정
                            </button>
                        </div>
            ...
            <div className="w-full max-w-sm mx-4 bg-gradient-to-br from-purple-900/90 to-pink-900/90 rounded-2xl p-6 border border-white/10 shadow-2xl">
                ...
                <div className="flex gap-3 mt-6">
                    ...
                    <button
                        ...
                        className="flex-1 py-3 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-medium rounded-xl disabled:opacity-50 hover:from-pink-600 hover:to-purple-600"
                    >
